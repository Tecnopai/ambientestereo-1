...
final popular3PostsController = FutureProvider<List<ArticleModel>>((ref) async {
  ...
  if (WPConfig.isPopularPostPluginEnabled == false) {
    allPosts = await repo.getPostByCategoryQty(pageNumber: 1, categoryID: 384, perPage: 4, );
  }
