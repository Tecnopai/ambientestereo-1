...
final popular2PostsController = FutureProvider<List<ArticleModel>>((ref) async {
  ...
  if (WPConfig.isPopularPostPluginEnabled == false) {
    allPosts = await repo.getPostByCategoryQty(pageNumber: 1, categoryID: 285, perPage: 4, );
  }
