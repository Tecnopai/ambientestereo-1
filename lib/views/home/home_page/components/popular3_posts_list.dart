...
import '../../../../core/controllers/posts/popular3_posts_controller.dart';
import '../../../../core/models/article.dart';
import 'loading_posts_responsive.dart';

class Popular3PostFetcherSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final popularPosts = ref.watch(popular3PostsController);
